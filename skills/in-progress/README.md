...
- **[cursor-handoff](./cursor-handoff/SKILL.md)** — Hand the current conversation off to a fresh Cursor Agent CLI session managed by Herdr, with tmux as a fallback. User-invoked.
