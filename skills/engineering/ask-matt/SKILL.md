...
- **`/pzero-skills`** — the framework reference for building and changing pzero services. It keeps REST, RPC, scheduled jobs, PostgreSQL database, migration, and generation work inside pzero's conventions; invoke it directly or let the model reach for it whenever a task uses pzero.
